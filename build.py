...
output_file_header = "Generated by isc-text-lists (https://github.com/anon-123456789/isc-text-lists) from the Internet Storm Center API (https://isc.sans.edu/api/).\nData licensed under CC BY-NC-SA 4.0."
...
print(f"Writing cloudcidrs to {cloudcidrs_filename}")
